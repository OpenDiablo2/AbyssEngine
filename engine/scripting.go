...
func (e *Engine) addScriptFunctions(script *tengo.Script) {
	...
	_ = script.Add("fmt", func(args ...tengo.Object) (tengo.Object, error) {
	...
	_ = script.Add("setBootText", func(args ...tengo.Object) (tengo.Object, error) {
		if len(args) != 1 {
	...
	_ = script.Add("log", func(args ...tengo.Object) (tengo.Object, error) {
		if len(args) != 2 {
	...
	_ = script.Add("getEngineSettings", func(args ...tengo.Object) (tengo.Object, error) {
		if len(args) != 0 {
	...
	_ = script.Add("joinPath", func(args ...tengo.Object) (tengo.Object, error) {
	...
	_ = script.Add("sleep", func(args ...tengo.Object) (tengo.Object, error) {
		if len(args) != 1 {
	...
	_ = script.Add("shutdown", func(args ...tengo.Object) (tengo.Object, error) {
		if len(args) != 0 {
	...
	_ = script.Add("addLoaderProvider", func(args ...tengo.Object) (tengo.Object, error) {
		if len(args) != 2 {
	...
	_ = script.Add("loadString", func(args ...tengo.Object) (tengo.Object, error) {
		if len(args) != 1 {
	...
	_ = script.Add("splitString", func(args ...tengo.Object) (tengo.Object, error) {
		if len(args) != 2 {
